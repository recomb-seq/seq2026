...
*The last decade has seen biological sequence databases grow from scarce, curated references into vast, heterogeneous collections spanning thousands of samples. This shift demands fundamentally new algorithmic approaches to store, index, and query sequence data at scale. In this talk, I will show how k-mer-based data structures provide a framework to aggregate and interrogate large collections of genomic and transcriptomic datasets. I will describe recent transformation of data structures to support k-mer presence and abundance across numerous samples. I will then discuss how these methods translate to metadata-aware queries with applications to pangenome annotation. Finally, I will illustrate the biological impact of this work on clinical use cases, including the discovery of aberrant RNA isoforms in acute myeloid leukemia that reduce subtype identification time from three weeks to one day. I will close with open algorithmic challenges at the intersection of k-mer indexing and relational databases.*

...
| <img src="{{ sp1_path }}" alt="Speaker 1" class="speaker-photo"><br><b>Speaker 1</b><br>Institute of Inst1 | <img src="{{ sp2_path }}" alt="Speaker 2" class="speaker-photo"><br><b>Speaker 2</b><br>Institute of Inst2 |
| :---: | :---: |
